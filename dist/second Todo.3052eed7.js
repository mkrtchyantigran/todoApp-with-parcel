...
window.addEventListener('DOMContentLoaded', ()=>{
    ...
    form.addEventListener("submit", (e)=>{
        ...
        if (e.target.task.value != "" && e.target.task.value.length > 3) {
            ...
            }).then(()=>getTasks()).catch((error)=>console.log("Error:", error)).finally(()=>e.target.reset());
        } else alert("please type your task..");
    });
    function getTasks() {
        tasksList.innerHTML = "";
        fetch("http://localhost:3333/tasks/").then((response)=>response.json()).then((data)=>{
          ...
          `;
            ...
            document.querySelectorAll("input[type='checkbox']").forEach((item)=>{
                item.addEventListener("change", (e)=>{
                    ...
                    }).then(()=>getTasks()).catch((e)=>console.log(e));
                });
            });
            document.querySelectorAll(".remove").forEach((item)=>{
                item.addEventListener("click", (e)=>{
                    ...
                    fetch(`http://localhost:3333/tasks/${id}`, {
                        method: "DELETE"
                    }).then(()=>getTasks()).catch((error)=>console.log("Error", error));
                });
            });
...
},{}],"aMz2Q":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["i4syP","9f5IL"], "9f5IL", "parcelRequire716c", {})

//# sourceMappingURL=second Todo.3052eed7.js.map
